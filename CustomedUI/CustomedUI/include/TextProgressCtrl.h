#ifndef __TEXTPROGRESSCTRL_H__
#define __TEXTPROGRESSCTRL_H__
...
//		call	GetBarColor()
//		or		SendMessage (PBM_GETBARCOLOR1, 0, 0)
//		or		::SendMessage (m_hwnd, PBM_GETBARCOLOR1, 0, 0)
//
...
#define PBM_GETBARCOLOR1			(WM_USER+100)
#define PBM_GETBKCOLOR1			(WM_USER+101)
...
class AFX_CLASS_EXPORT CTextProgressCtrl : public CProgressCtrl
{
	...
	public:
		...
		inline COLORREF GetBarColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_GETBARCOLOR1, 0, 0)); }
		...
		inline COLORREF GetBarBkColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_GETBKCOLOR1, 0, 0)); }
